...
export default function OrderSuccessModal({ order, isOpen, onClose, settings, onCancelOrder }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-xs flex flex-col justify-end sm:justify-center sm:items-center p-0 sm:p-4 overflow-hidden">
      <div className="relative bg-white rounded-t-[2.5rem] sm:rounded-3xl max-w-lg w-full overflow-hidden shadow-2xl border-t sm:border border-gray-200 animate-in slide-in-from-bottom sm:zoom-in-95 duration-200 max-h-[85vh] sm:max-h-[90vh] flex flex-col">
        {/* Mobile Drag Indicator */}
        <div className="w-14 h-1.5 bg-gray-300/80 rounded-full mx-auto my-2.5 sm:hidden shrink-0" />
